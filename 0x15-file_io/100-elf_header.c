 ...
 *
 * Description: If the file is not an ELF file or on error - exit status
 ...
 * @elf: The file descriptor (FD) of the ELF file
 *
...
/**
 * main - function to display the information contained in the ELF
